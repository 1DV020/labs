...
The Linux server will be the main DNS for mycompany.lab. The Linux server will also act as web server for mycompany.lab and the windows server will be responsible for handing out IP addresses with DHCP.
